  ...
  if (!client.connected()) {
    ...
    //read the pins we need here
       val = digitalRead(inPin);   // read the input pin
        ...
        // client.println((potsendval/1024), 4); // Send the value with NEW LINE
         client.print(potsentval);
         
                 Serial.print("SETD^i.0.mix^");
              //   Serial.println((potsendval/1024), 4);
                     client.print(potsendval);
         }
}
